	...
	<div data-role="page">
		...
		<div data-role="content">
				<form method="POST"
					...
					<!-- <input name="date_of_service" id="date_of_service" type="date" data-role="datebox" data-options='{"mode": "datebox"}' placeholder="Tap to Select Date of Service" readonly>-->
