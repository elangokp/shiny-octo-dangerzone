...
var smt2fn = {
  ...
  sendAjaxRequest: function(setup)
  {
    ...
    if (setup.postdata) {
    	//alert("Inside postdata true : " + setup.postdata);
    ...
    //alert("Before sending postdata : " + setup.postdata);
    // send request
