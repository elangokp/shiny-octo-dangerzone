 ...
 */
class WP_Insights_Recording_PS_Stats_List_Table extends WPI_WP_List_Table {
    ...
    function column_browser_open_time($item){
    ...
    function column_focused_browsing_time($item){
