...
<?php
	...
	function single_row( $item ) {
		...
		if ( method_exists( $this, 'full_row_actions') ) {
			echo '<tr' . $row_class . '>';
			echo '<td style="border-top-style: none;" colspan="'.$this->get_column_count().'">';
			echo call_user_func( array( &$this, 'full_row_actions' ), $item );
			echo '</td>';
			echo '</tr>';
		}
	}
